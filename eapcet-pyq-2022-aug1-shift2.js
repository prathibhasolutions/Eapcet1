(function () {
  ...
  var NEW_EXAM_ID = "eapcet-pyq-2022-aug1-shift2";
  ...
  function loadPayload() {
    ...
    xhr.open("GET", "new-exam-temp-eapcet-pyq-2022-aug1-shift2.json", false);
    xhr.send(null);
  ...
  try {
    ...
    newExam.title = "TG EAPCET Previous Year Paper - Mechanical Engineering 1st Aug 2022 Shift2";
    newExam.date = "2022-08-01";
